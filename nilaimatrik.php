...
<div class="form-group">
							...
							<div class="col-lg-4">
								...
								$s=mysqli_query($connect,"select * from alternatif");
...
<div class="form-group">
								<?php
								$i=1;
								$alt=mysqli_query($connect,"select * from kriteria");
						//hitung jml kriteria		
...
<?php
$b=mysqli_query($connect,"select * from kriteria");
...
//cek id alternatif
$id_alt=$_POST['id_alt'];
$cek=mysqli_query($connect,"select * from alternatif where id_alternatif='$id_alt'");
$cek_l=mysqli_num_rows($cek);
if($cek_l>0){
	$del=mysqli_query($connect,"delete from nilai_matrik where id_alternatif='$id_alt'");
}
...
for($n=1;$n<=$jml_krit;$n++){
	...
	$m=mysqli_query($connect,"insert into nilai_matrik (id_alternatif,id_kriteria,nilai) values('$_POST[id_alt]','$id_k','$nilai_k')");
